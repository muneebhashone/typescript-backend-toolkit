...
<<<<<<<< HEAD:migrations/0000_spicy_blonde_phantom.sql
	"cancellation_policies" integer[] DEFAULT 'ARRAY[]'::integer[],
	"facilities" integer[] DEFAULT 'ARRAY[]'::integer[],
	"house_rules" integer[] DEFAULT 'ARRAY[]'::integer[],
	"discounts" integer[] DEFAULT 'ARRAY[]'::integer[],
========
	"cancellation_policies" integer[] DEFAULT '{}',
	"facilities" integer[] DEFAULT '{}',
	"house_rules" integer[] DEFAULT '{}',
	"discounts" integer[] DEFAULT '{}',
>>>>>>>> e1cf2fbfd85c3da3b08670c33cc405ae9ce2aab2:migrations/0000_stormy_cyclops.sql
	"updated_at" date,
	"created_at" date
);
--> statement-breakpoint
